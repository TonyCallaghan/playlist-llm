...
describe('InputFields Component', () => {
    ...
    it('displays correct inputs for "Artist to Artist" tab', () => {
        ...
        expect(
            screen.getByPlaceholderText('Kanye West')
        ).toBeInTheDocument();
        expect(
            screen.getByPlaceholderText('Taylor Swift')
        ).toBeInTheDocument();
    });
    ...
    it('displays correct dropdowns for "Instrument" tab', () => {
        ...
        expect(screen.getByPlaceholderText('Genre | Artist | Any')).toBeInTheDocument();
    ...
    it('displays a message when no songs are present', () => {
        render(<InputFields />);
        expect(screen.getByText('Create a playlist to see results here.')).toBeInTheDocument();
    });
});